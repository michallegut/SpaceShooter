...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public Text destroyedDronesInformation;
        ...
        private void Update()
        {
            ...
            if (Input.GetMouseButtonDown(0) && m_CharacterController.isGrounded && !weaponShootSound.isPlaying)
            {
                ...
                if (Physics.Raycast(m_Camera.transform.position, m_Camera.transform.forward, out hit))
                {
                    if (hit.transform.tag.Equals("Drone"))
                    {
                        ...
                        GameObject.Destroy(hit.transform.gameObject, 0.75f);
                        destroyedDronesInformation.text = "DESTROYED DRONES " + (++destroyedDrones) + " / 6";
                        if (destroyedDrones == 6)
                        {
        ...
        private void FixedUpdate()
        {
            ...
            if (laser != null)
            {
                laser.SetPosition(0, Vector3.MoveTowards(laser.GetPosition(0), laser.GetPosition(1), 2));
                if (laser.GetPosition(0).Equals(laser.GetPosition(1)))
                {
